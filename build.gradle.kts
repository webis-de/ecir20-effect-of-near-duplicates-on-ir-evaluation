...
dependencies {
    ...
    implementation("org.apache.spark:spark-graphx_2.12:2.4.3")
    implementation("org.apache.spark:spark-core_2.12:2.4.3")
    implementation("org.slf4j:slf4j-log4j12:1.7.26")
    implementation("com.jayway.jsonpath:json-path:2.4.0")
    implementation("io.anserini:anserini:0.5.1")
    ...
    implementation("client.netspeak:netspeak-client:1.3.5")
    implementation("net.jodah:failsafe:2.0.1")
    implementation("org.apache.solr:solr-core:8.1.1")
    implementation("com.github.mam10eks:jtreceval:-SNAPSHOT")
    ...
    testImplementation("com.holdenkarau:spark-testing-base_2.12:2.4.3_0.12.0")
}
