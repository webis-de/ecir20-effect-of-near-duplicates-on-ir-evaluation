...
//			throw new RuntimeException("Error to minus '" + diff + "' from : " + tmp);
	...
	public static InputStream openRunFile(Path p) {
		//FIXME this code is duplicated with RankingResults of Anserini.
		// Maybe we should fix the problem with empty-lines in run-files in Anserinis RankingResults to be able to remove our code?
